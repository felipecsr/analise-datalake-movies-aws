...
spark = SparkSession.builder \
    .master("local[*]") \
    .appName("Laboratório Etapa 6 - Corrigido") \
    .getOrCreate()
...
# Filtrando apenas pessoas nascidas a partir do ano 2000
df_nascidos_2000 = df_nomes.filter(col("ano_nascimento") >= 2000)

# Exibindo as 10 primeiras linhas do DataFrame filtrado
print("Exibindo as 10 primeiras linhas de pessoas nascidas a partir do ano 2000:")
df_nascidos_2000.show(10)
